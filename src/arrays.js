...
function bWords(words) {
  return words.filter(word => word.toLowerCase().startsWith('b'));
}
...
function everyOtherItem(items) {
  return items.filter((items, index) => index % 2 === 0);
}
...
let smallestItems = items.slice(0, n);
smallestItems.reverse();
...
// make this look nicer eventually :)
